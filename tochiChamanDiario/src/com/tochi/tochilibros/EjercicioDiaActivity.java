 ...
 * 
 */ 
public class EjercicioDiaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ejerciciodia);
...
//		myWebView.setWebViewClient(new WebViewClient());
		...
		myWebView.loadUrl("https://www.youtube.com/watch?v=HUxQl-Hdltw&index=2&list=PL1FNiYvPuxeNl8SN5PDYhj7oPrtTRyXvt");
